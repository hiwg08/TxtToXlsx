...
public:
    ...
    /// @deprecated Use Cells.CheckCell(int row, int column) instead.
    [[deprecated]] ASPOSE_CELLS_API Cell GetCell(int32_t row, int32_t column);
    /// <summary>
    ...
    /// This method will be removed 12 months later since February 2024.
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use Cells.CheckRow(int row) instead.
    [[deprecated]] ASPOSE_CELLS_API Row GetRow(int32_t row);
    /// <summary>
    /// Gets the <see cref="Cell"/> element or null at the specified cell row index and column index.
    /// </summary>
    /// <param name="row">Row index</param>
    ...
    /// <returns></returns>
    ASPOSE_CELLS_API double GetColumnOriginalWidthPoint(int32_t column);
    /// <summary>
    /// Hides a column.
    /// </summary>
    /// <param name="column">Column index.</param>
    ...
    /// </summary>
    /// <param name="column">Column index</param>
    /// <param name="original">Indicates whether returning original width even when the column is hidden
    /// </param>
    /// <returns>Width of column in normal view.</returns>
    ASPOSE_CELLS_API int32_t GetColumnWidthPixel(int32_t column, bool original);
    /// <summary>
