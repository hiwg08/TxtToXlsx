...
public:
    ...
    [[deprecated]] ASPOSE_CELLS_API U16String GetName();
    /// <summary>
    /// Get or set the name of table to import from html
    /// </summary>
    /// @deprecated Please use HtmlTableLoadOption.Id instead
    [[deprecated]] ASPOSE_CELLS_API void SetName(const U16String& value);
    /// <summary>
    /// Get or set the name of table to import from html
    /// </summary>
    /// @deprecated Please use HtmlTableLoadOption.Id instead
    [[deprecated]] ASPOSE_CELLS_API void SetName(const char16_t* value);
    /// <summary>
