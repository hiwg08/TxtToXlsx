...
public:
    ...
    [[deprecated]] ASPOSE_CELLS_API bool GetMergeEmptyTdForcely();
    /// <summary>
    /// Indicates whether merging empty TD element forcedly when exporting file to html.
    /// The size of html file will be reduced significantly after setting value to true. The default value is false.
    /// If you want to import the html file to excel or export perfect grid lines when saving file to html,
    ...
    /// </summary>
    /// @deprecated Use HtmlSaveOptions.MergeEmptyTdType instead.
    [[deprecated]] ASPOSE_CELLS_API void SetMergeEmptyTdForcely(bool value);
    /// <summary>
    /// The option to merge contiguous empty cells(empty td elements)
    /// The default value is MergeEmptyTdType.Default.
    /// </summary>
    ASPOSE_CELLS_API MergeEmptyTdType GetMergeEmptyTdType();
    /// <summary>
    /// The option to merge contiguous empty cells(empty td elements)
    /// The default value is MergeEmptyTdType.Default.
    /// </summary>
    ASPOSE_CELLS_API void SetMergeEmptyTdType(MergeEmptyTdType value);
    /// <summary>
    ...
    /// Only works when <see cref="SaveAsSingleFile"/> is True.
    /// </summary>
    ASPOSE_CELLS_API U16String GetCssStyles();
    /// <summary>
    /// Gets or sets the additional css styles for the formatter.
    /// Only works when <see cref="SaveAsSingleFile"/> is True.
    /// </summary>
    ASPOSE_CELLS_API void SetCssStyles(const U16String& value);
    /// <summary>
    /// Gets or sets the additional css styles for the formatter.
    /// Only works when <see cref="SaveAsSingleFile"/> is True.
    /// </summary>
    ASPOSE_CELLS_API void SetCssStyles(const char16_t* value);
    /// <summary>
    /// Indicates whether to hide overflow text when the cell format is set to wrap text.
    /// The default value is false
    /// </summary>
    ASPOSE_CELLS_API bool GetHideOverflowWrappedText();
    /// <summary>
    /// Indicates whether to hide overflow text when the cell format is set to wrap text.
    /// The default value is false
    /// </summary>
    ASPOSE_CELLS_API void SetHideOverflowWrappedText(bool value);
